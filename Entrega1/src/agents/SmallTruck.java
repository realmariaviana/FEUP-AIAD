...
public class SmallTruck extends Truck {
    ...
    protected void setup() {
        ...
        capacity = 1;
        System.out.println("Small Truck " + getAID().getName() + " is ready.");
        ...
        // Register the small truck in the yellow pages
    ...
    protected void takeDown() {
        ...
        System.out.println("Small Truck " + getAID().getName() + " terminating.");
    }
}
